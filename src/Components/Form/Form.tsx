...
import { addContact, editContact } from "../../libs/Redux/Reducers/reducer";
import { RootState } from "../../libs/Redux/Stores/store";

const Form = () => {
  const { crudState, toggleModal, clickedContactData } = useAppContext();
  ...
  const handleSubmit = (event: any) => {
    ...
    if (crudState === CrudStateEnum.EDIT_CONTACT) {
      ...
      contactData[contactIndex] = editedValue;
          ...
          <label className="inline-flex items-center">
            <input
              ...
              checked={
                ...
                clickedContactData.contact_status === ContactStatusEnum.INACTIVE
              }
              onChange={handleRadioChange}
            />
